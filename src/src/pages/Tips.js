            ...
            <div className="articles">
                <div className="articles_wrapper">
                    <div className="articles_card">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://medium.com/@imaazzahra38/tips-pencegahan-eating-disorder-e7b25e958bcc" className="articles_btn" ><button><b>Baca Selengkapnya</b></button></a>
                    </div>
                </div>
                <div className="articles_wrapper">
                    <div className="articles_card">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://medium.com/@imaazzahra38/gejala-anoreksia-dan-cara-mengatasinya-a3acddaef905" className="articles_btn" ><button><b>Baca Selengkapnya</b></button></a>
                    </div>
                </div>
                <div className="articles_wrapper">
                    <div className="articles_card">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://medium.com/@sarahazkarief/10-tips-for-a-healthy-diet-f8f6dc8b552a" className="articles_btn" ><button><b>Baca Selengkapnya</b></button></a>
                    </div>
                </div>
                <div className="articles_wrapper">
                    <div className="articles_card">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://medium.com/@sarahazkarief/safe-weight-loss-exercises-7e6adb3ebab" className="articles_btn" ><button><b>Baca Selengkapnya</b></button></a>
                    </div>
                </div>
                <div className="articles_wrapper">
                    <div className="articles_card">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://medium.com/@nelsenputra/selain-mengetahui-bmi-ini-dia-lima-tanda-berat-badan-seseorang-disebut-ideal-178c36f37841" className="articles_btn" ><button><b>Baca Selengkapnya</b></button></a>
                    </div>
                </div>
                <div className="articles_wrapper">
                    <div className="articles_card">
